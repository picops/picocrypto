...
def test_eip712_hash_full_message() -> None:
    full = {
        "domain": {"name": "Test", "version": "1", "chainId": 1, "verifyingContract": "0x" + "00" * 20},
        "types": {"Mail": [{"name": "from", "type": "address"}, {"name": "message", "type": "string"}]},
        "primaryType": "Mail",
...
def test_eip712_hash_agent_message() -> None:
    domain = {"name": "A", "version": "1", "chainId": 1, "verifyingContract": "0x" + "00" * 20}
...
def test_ed25519_verify_rejects_tampered() -> None:
    ...
    assert ed25519_verify(ED25519_TEST1_MSG, bytes(63) + b"\x00", ED25519_TEST1_PUBLIC) is False
