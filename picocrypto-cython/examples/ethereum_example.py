...
from cycrypto import eip712_hash_full_message, keccak256, privkey_to_address, privkey_to_pubkey, sign_recoverable

privkey = bytes(31) + bytes([1])
address = privkey_to_address(privkey)
r, s, v = sign_recoverable(privkey, keccak256(b"Hello, Ethereum"))
full_message = {
    "domain": {"name": "Example", "version": "1", "chainId": 1, "verifyingContract": "0x" + "00" * 20},
